                ...
                <table class="table table-hoverr" style="table-layout: fixed; width: 100%;">
                    ...
                    <tbody id="table-konten">
                        ...
                        <tr id="index_{{ $konten->id }}">
                            <td class="row-index">{{ ($beritas->currentPage() - 1) * $beritas->perPage() + $loop->iteration }}</td>
                            <td>{{$konten->judul}}</td>
                            <td>{{$konten->tags}}</td>
                ...
                <nav aria-label="Page navigation">
                    <ul class="pagination">
                        ...
                        <li class="page-item {{ $beritas->onFirstPage() ? 'disabled' : '' }}">
                            <a class="page-link" href="{{ $beritas->previousPageUrl() }}">Sebelumnya</a>
                        </li>
                        ...
                        <li class="page-item {{ !$beritas->hasMorePages() ? 'disabled' : '' }}">
                            <a class="page-link" href="{{ $beritas->nextPageUrl() }}">Selanjutnya</a>
                        </li>
                    </ul>
                </nav>
            </div>

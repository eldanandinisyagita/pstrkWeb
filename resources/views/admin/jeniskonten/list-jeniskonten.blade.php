                ...
                <table class="table table-hoverr">
                    ...
                    <tbody id="table-jenis_kontens">
                        ...
                        <tr id="index_{{ $jenis_konten->id }}">
                            <td>{{ ($jenis_kontens->currentPage() - 1) * $jenis_kontens->perPage() + $loop->iteration }}</td>
                            <td>{{ $jenis_konten->jenis }}</td>
                            <td>
                                <a href="javascript:void(0)" id="btn-edit-post" data-id="{{ $jenis_konten->id }}" class="button-edit btn btn-sm"><i class="bi bi-pencil-square me-2"></i>Edit</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
                ...
                <nav aria-label="Page navigation">
                    <ul class="pagination">
                        ...
                        <li class="page-item {{ $jenis_kontens->onFirstPage() ? 'disabled' : '' }}">
                            <a class="page-link" href="{{ $jenis_kontens->previousPageUrl() }}">Sebelumnya</a>
                        </li>
                        ...
                        <li class="page-item {{ !$jenis_kontens->hasMorePages() ? 'disabled' : '' }}">
                            <a class="page-link" href="{{ $jenis_kontens->nextPageUrl() }}">Selanjutnya</a>
                        </li>
                    </ul>
                </nav>
            </div>

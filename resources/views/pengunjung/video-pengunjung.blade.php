      ...
      <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-8">
                ...
                <div id="galeri-container-video" class="galeri-container-video mb-4">
                    @foreach($videos as $video)
                    <div class="galeri-item">
                        <div class="galeri-video" onclick="openPopup('{{ url('storage/video/'.$video->lampiran) }}')">
                            <video class="video-thumbnail" width="200px" height="200px" controls>
                ...
                @if($videos->hasMorePages())
                    <div class="text-center">
                        <button id="load-more-video" data-page="2" class="btn btn-load">Video lainnya</button>
                    </div>
                @endif
                ...
                <script>
                    document.getElementById('load-more-video').addEventListener('click', function() {
                        ...
                        fetch(`/videoPengunjung?page=${page}`, {
                            headers: {
                        ...
                        .then(data => {
                            let container = document.getElementById('galeri-container-video');

                            // Append the loaded videos to the gallery
                            data.data.forEach(video => {
                                let galeriItem = document.createElement('div');
                                galeriItem.classList.add('galeri-item');
                                galeriItem.innerHTML = `
                                    <div class="galeri-video" onclick="openPopup('${video.lampiran_url}')">
                                        <video class="video-thumbnail" width="200px" height="200px" controls>
                                            <source src="${video.lampiran_url}" type="video/mp4">
                                            Your browser does not support the video tag.
                                        </video>
                                    </div>
                                    <div class="galeri-info-video">
                                        <h6>${video.judul}</h6>
                                        <p style="font-size: 12px">${new Date(video.tgl_publish).toLocaleDateString()}</p>
                                    </div>
                                `;
